...
function setup() {
  ...
  invisible=createSprite(200,197,400,5);
...
function clouds(){
  if (frameCount%60===0){
    cloud=createSprite(600,70, 50,30);
...
function obstaculos(){
  if(frameCount%60===0){
    obstaculo=createSprite(600,170,20,40);
...
function meteoritos(){
  if(frameCount%100===0){
    ...
    switch(rand){
      case 1: meteorito=createSprite(590,0,20,20);
        ...
        break;
      case 2: ave=createSprite(0,50,20,20);
        ave.velocityX=5;
